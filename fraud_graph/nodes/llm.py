"""Node LLM utilisant Google ADK pour l'analyse approfondie."""
...
def load_system_prompt() -> str:
    """Charge le system prompt depuis le fichier spécifié dans SYSTEM_PROMPT_FILE.
...
def create_fraud_agent() -> Agent:
    """Crée l'agent Google ADK pour l'analyse de fraude.
    ...
    try:
        ...
        return {
            **state,
            ...
            "explanation": f"Erreur lors de l'analyse LLM: {str(e)}",
        }
